...
# Type alias for parameter selectors
ParameterSelector = (
    pc.MissingValuesIndicatorParameterSelector
    | pc.MissingValuesHandlerParameterSelector
    | pc.OutliersParameterSelector
    | pc.DateTimeTransformerParameterSelector
    | pc.CyclicalFeaturesTransformerParameterSelector
    | pc.NumericalBinningParameterSelector
    | pc.MathematicalOperationsParameterSelector
    | pc.SplineTransformationParameterSelector
    | pc.CategoricalEncodingParameterSelector
    | pc.NonLinearTransformationParameterSelector
    | pc.NormalizationParameterSelector
    | pc.QuantileTransformationParameterSelector
    | pc.ScaleTransformationParameterSelector
    | pc.ColumnSelectionParameterSelector
    | pc.DimensionalityReductionParameterSelector
)
...
def auto_feature_pipeline(
    ...
    if normalization:
        ...
        transformations_1: list[dict] = []
        transformations_2: list[dict] = []
        tracked_columns_1: list = []
        tracked_columns_2: list = []
