...
def test_transformations_are_applied(load_data):
        ...
        [
            MissingValuesHandler(
                transformation_options={
                    "sepal length (cm)": "most_frequent",
                    "sepal width (cm)": "knn",
                    "petal length (cm)": "most_frequent",
    ...
    x_test, _y_test = x[point:], y[point:]
    ...
    assert all(col in transformed_x_test.columns for col in expected_columns), (
